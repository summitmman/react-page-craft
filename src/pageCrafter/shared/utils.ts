import { HANDLE_REGEX, HANDLE_REGEX_GLOBAL } from './constants';

export const cleanVariable = (str: string) => str.replace('{', '').replace('}', '').trim();

export const getReactiveVar = (str: string) => {
